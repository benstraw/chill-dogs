...
<article class="collector-article container">
  ...
  <div class="prose">
    ...
    <p>
      ...
      <a href={ROUTES.comfortCalmingBeds} data-track="collector_to_converter_click" data-from-page="how-to-fly-with-a-dog" data-to-page={ROUTES.comfortCalmingBeds} data-link-position="section">calming bed picks</a>
      {' '}are the same category I would draw a travel insert from. If you want a portable option specifically for airport downtime, hotel floors, or settling at the destination, compare our{' '}
      <a href={ROUTES.comfortTravelBeds} data-track="collector_to_converter_click" data-from-page="how-to-fly-with-a-dog" data-to-page={ROUTES.comfortTravelBeds} data-link-position="section">dog travel bed picks</a>.
    </p>
