...
<article class="collector-article container">
  ...
  <div class="prose">
    ...
    <p>
      If you already know the real issue is containment strength rather than anxiety pattern, go straight to our <a href={ROUTES.comfortHeavyDutyCrates} data-track="collector_to_converter_click" data-from-page={pageSlug} data-to-page={ROUTES.comfortHeavyDutyCrates} data-link-position="section">heavy-duty dog crate comparison</a>.
    </p>
    <p>
