...
<article class="collector-article container">
  ...
  <div class="prose">
    ...
    <p>
      If flying is the actual goal, use our <a href={ROUTES.comfortAirlineCrates} data-track="collector_to_converter_click" data-from-page={pageSlug} data-to-page={ROUTES.comfortAirlineCrates} data-link-position="section">airline crate comparison</a> to separate rigid flight kennels from road-trip and house-training options.
    </p>
    <p>
    ...
    <p>
      If the crate will live in a visible bedroom or living room every day, compare our <a href={ROUTES.comfortFurnitureCrates} data-track="collector_to_converter_click" data-from-page={pageSlug} data-to-page={ROUTES.comfortFurnitureCrates} data-link-position="section">furniture dog crate picks</a> before defaulting to a standard wire setup. If placement is constrained — a bedroom corner, flush against a wall, beside existing furniture — look specifically at the double-door options on that page; the side-access door makes those positions much more practical without sacrificing the furniture look.
    </p>
    <p>
    ...
    <p>
      If you already know the real issue is containment strength rather than anxiety pattern, go straight to our <a href={ROUTES.comfortHeavyDutyCrates} data-track="collector_to_converter_click" data-from-page={pageSlug} data-to-page={ROUTES.comfortHeavyDutyCrates} data-link-position="section">heavy-duty dog crate comparison</a>. That page also includes reinforced furniture-style options for escape artists who still want the crate to match their home's decor.
    </p>
    <p>
