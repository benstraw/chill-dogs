...
export const newsletterCtaHref = `${ROUTES.subscribe}?utm_source=article&utm_medium=cta&utm_campaign=fireworks_safety&utm_content=exit_before_dark`;
...
<article class="collector-article container">
  ...
  <div class="prose">
    ...
    <aside class="newsletter-callout" aria-labelledby="fireworks-newsletter-heading">
      <p id="fireworks-newsletter-heading" class="newsletter-callout__heading">Get the calm-dog checklist before fireworks night</p>
      <div class="newsletter-callout__copy">
        <ul class="newsletter-callout__list">
          <li>Calming setup tips before you leave</li>
          <li>The exit-before-dark reminder</li>
          <li>Safety gear to bring</li>
        </ul>
      </div>
      <div class="newsletter-callout__action">
        <a
          href={newsletterCtaHref}
          class="newsletter-callout__link"
          data-track="newsletter_cta_click"
          data-cta-type="newsletter"
          data-topic="fireworks_safety"
          data-placement="exit_before_dark"
          data-source-page={pageSlug}
        >
          <span class="newsletter-callout__link-text">Subscribe for updates</span>
        </a>
        <p class="newsletter-callout__fine">No spam. Unsubscribe any time.</p>
      </div>
    </aside>
