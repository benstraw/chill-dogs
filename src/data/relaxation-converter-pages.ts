    ...
    blocks: [
      {
        ...
        heading: 'Quick Picks',
        intro:
          'Serious chewers usually do better with elevated cots or flat crate pads. Moderate chewers and diggers may be fine with tougher rip-stop covers.  No bed is safe if your dog is actively eating pieces of it.',
        items: [
          {
            label: 'Best Overall',
            title: 'K9 Ballistics Armored Crate Bed',
            description:
              'A strong pad with fewer plush weak points than a standard soft bed.',
          ...
          },
          {
            ...
            description:
              'Removes stuffing and soft corners while adding airflow for dogs who run hot.',
            productId: 'k9-ballistics-elevated-cooling-bed',
            position: 'quick-picks-2',
          },
          {
            label: 'Best Washable Rip-Stop Bed',
            title: 'K9 Ballistics Tough Ripstop Oval Bolster Dog Bed',
            description:
              'A tough, washable bed for moderate chewers, diggers, and nesters who prefer a more enclosed bed shape.',
            productId: 'k9-ballistics-ripstop-oval-bolster-bed',
            position: 'quick-picks-3',
          },
          {
            label: 'Best Budget Elevated Bed',
            title: 'Veehoo Chewproof Elevated Dog Bed',
            description:
              'A lower-cost cooling alternative with a chew-proof design.',
      ...
      },
      {
        ...
        intro:
          'Choose the right format first: elevated cot for serious chewers, flat crate pad for kennel diggers, orthopedic support for older dogs, or tough comfort bed for nesters.',
        headings: {
          bestFor: 'Best For',
          style: 'Bed Type',
          focus: 'Why It Works',
        ...
        items: [
          {
            productId: 'k9-ballistics-armored-crate-bed',
            bestFor: 'Overall padded pick',
            style: 'Armored padded crate bed',
            focus: 'Fewer plush weak points',
            care: 'No bed is industructible for every dog',
          },
          {
            productId: 'k9-ballistics-elevated-cooling-bed',
            bestFor: 'Elevated chew-proof cooling bed',
            style: 'Elevated cooling cot',
            focus: 'No stuffing or soft bolsters, facilitates airflow',
            care: 'Firmer cot feel is not for every dog',
          },
          {
            productId: 'fxw-titannest-elevated-bed',
            bestFor: 'Indoor/outdoor/camping use',
