...
export const calmingProducts: CalmingProduct[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Simple starter format for dogs new to licking enrichment',
    ],
  ...
  },
  {
    ...
    bullets: [
      'Stainless steel build is a sturdier alternative to flexible silicone',
      'Flat textured surface supports spreadable treats without adding a puzzle-toy feel',
      'Dishwasher-friendly material can be practical for frequent use',
    ],
    bestFor: 'Dogs that damage silicone mats',
    howItHelps: 'Durable licking enrichment',
  ...
  },
  {
    ...
    bestFor: 'Durable frozen treat and wet-food enrichment',
    howItHelps: 'Stainless bowl-style licking surface',
  ...
  },
  {
    ...
    bullets: [
      'Stainless textured surface gives chewers a tougher option than silicone',
      'Suction-style setup can help with crate-side or fixed-position enrichment',
      'Better for dogs who push lightweight mats around the floor',
    ],
    bestFor: 'Crate enrichment and dogs who shove mats around',
    howItHelps: 'Fixed-position stainless licking enrichment',
    considerIf: 'You need a more stable, chew-resistant mat setup than flat silicone',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Good fit when you want enrichment to last longer than a thin smear',
    ],
  ...
  },
  {
    ...
    bullets: [
      'Premium brand-name option for owners who prefer established pet brands',
      'Bubble-style surface gives spreadable treats more texture than a plain tray',
      'A polished pick for giftable enrichment or an everyday home setup',
    ],
    bestFor: 'Premium brand shoppers who want a nicer everyday mat',
    howItHelps: 'Textured premium licking enrichment',
    considerIf: 'You are comfortable paying more for a known pet brand and cleaner presentation',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Useful for road trips, visiting family, or prepared outdoor breaks',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Adjacent option when pace control matters more than calming licking',
    ],
    bestFor: 'Dogs who need slower meals instead of a lick mat',
    howItHelps: 'Slow-feeding meal control',
    considerIf: 'Your priority is slowing meals, not creating a fireworks-night distraction',
