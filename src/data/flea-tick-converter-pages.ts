...
export const fleaTickConverterPages: Record<string, FleaTickConverterPageConfig> = {
  ...
  'best-natural-flea-and-tick-products-for-dogs': {
    ...
    description:
      'Compare natural flea and tick options for dogs — sprays, spot-ons, shampoos, and collars — with practical notes on reapplication and real-world limits.',
    ...
    hero: {
      title: 'Best Natural Flea and Tick Products for Dogs',
      subtitle:
        'This page is for owners who already know they want a lower-toxicity, plant-based routine. The honest trade-off is that natural options are best at prevention layers and light-load support, not at replacing heavy-duty conventional control in high-pressure regions.',
      disclaimer: 'As an Amazon Associate and a Chewy Affiliate, we earn from qualifying purchases.',
      primaryCta: { label: 'See Wondercide Sprays', href: '#sprays' },
    ...
    toc: [
      ...
      { label: 'Spot-On', anchor: 'spot-on' },
      { label: 'Shampoo', anchor: 'shampoo' },
      { label: 'Collar', anchor: 'collar' },
    ...
    blocks: [
      {
        ...
        paragraphs: [
          'Natural flea and tick products make the most sense when you are trying to reduce pesticide load, your dog has lighter exposure, and you are willing to do the routine work that makes them more useful: coat checks, bedding cleanup, bath support, and fast reassessment when you still see pests.',
      ...
      },
      {
        ...
        intro:
          'Wondercide spray is the easiest natural product to understand because the format matches the job. Spray when you need contact coverage now. Reapply often. Keep expectations realistic. In mixed-pet homes, read the cat language before choosing peppermint or lemongrass versions.',
        positionOffset: 0,
        columns: 3,
        productIds: [
          'wondercide-spray-lemongrass',
          'wondercide-spray-peppermint',
          'wondercide-spray-cedarwood',
        ],
      },
      {
        kind: 'product_section',
        id: 'spot-on',
        heading: 'Spot-on when you want less daily work',
        intro:
          'Spot-on is the better fit for owners who know they will not maintain a full spray routine. It is still prevention-first. If you are already dealing with a real infestation, treat spot-on as part of the plan rather than the whole answer.',
        positionOffset: 3,
        columns: 1,
        productIds: ['wondercide-spot-on-medium'],
        alt: true,
      },
      {
        kind: 'product_section',
        ...
        intro:
          'Shampoo is not your prevention strategy by itself. It is your cleanup tool after exposure, during light flea pressure, or when you are trying to make coat checks and bath support easier to sustain.',
        positionOffset: 4,
        columns: 1,
        productIds: ['wondercide-shampoo-peppermint'],
      },
      {
        kind: 'product_section',
        id: 'collar',
        heading: 'Collar option for owners who prefer a wearable routine',
        intro:
          'The natural collar category is more about steady prevention layering than about rescue-level control. Treat it like a convenience layer, not like a substitute for evidence-heavy medication in high-exposure situations.',
        positionOffset: 5,
        columns: 1,
        productIds: ['wondercide-collar-peppermint'],
        alt: true,
      },
      {
        kind: 'callout',
    ...
    faq: {
      ...
      items: [
        ...
        {
          question: 'Should I choose spray, spot-on, shampoo, or collar?',
          answer:
            'Spray is the best place to start if you want flexibility and understand reapplication. Spot-on is better when you want less daily work. Shampoo is support, not standalone prevention. Collar is a convenience layer for owners who already understand natural options have lighter evidence.',
        },
      ],
    },
    internalLinkStripHeading: 'More Flea, Tick, and Outdoor Safety Guides',
