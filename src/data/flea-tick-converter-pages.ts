...
export const fleaTickConverterPages: Record<string, FleaTickConverterPageConfig> = {
  ...
  'best-flea-and-tick-products-for-dogs': {
    ...
    toc: [
      ...
      { label: 'The Natural Options', anchor: 'natural-options' },
      { label: 'Sprays, Oils & Wipe-Ons', anchor: 'sprays' },
      { label: 'Shampoos', anchor: 'shampoo' },
      { label: 'Collars & Tags', anchor: 'collar' },
      { label: 'Daily Chews', anchor: 'chews' },
    ...
    blocks: [
      ...
      },
      {
        ...
        heading: 'Collars and Wearable Tags',
        intro:
          'Collars and tags provide flea and tick protection for months at a time. They must be worn continuously for full effect.',
        positionOffset: 15,
        columns: 3,
        visibleCount: 6,
        productIds: [
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            'Check every label, because both the conventional and the natural products on this page include ones that are unsafe for cats. Permethrin, used in some topicals, is toxic to cats and should not be used in a household with them. On the natural side, peppermint essential oil is also toxic to cats, so a plant-based label does not by itself mean cat-safe. When in doubt, consult your veterinarian.',
        },
        {
