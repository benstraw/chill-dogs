...
export const relaxationProducts: RelaxationProduct[] = [
  ...
  },
  {
    ...
    bestFor: 'Short-trip travelers who want one bag that handles both the flight and the first day at the destination',
    whyItWorks: 'Roll-flat construction solves the storage problem between trips without giving up carry capacity when you actually need it',
    considerIf: 'You pack light and want a single tote that functions as your day-of bag and fits under the seat',
  ...
  },
  {
    ...
    whyItWorks: 'Pre-assigned compartments eliminate the hunting-through-the-bag problem at check-in, security, or boarding — everything stays exactly where you put it',
    considerIf: 'You tend to overpack and want a bag that enforces organization through its structure rather than relying on willpower',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Zipper top keeps contents secure in overhead bins or under seats without anything spilling',
      'Budget price makes it practical as a dedicated dog bag you pack ahead and leave ready to grab',
    ],
    bestFor: 'Budget-conscious travelers who need a no-frills dog kit bag without paying for extra features',
    whyItWorks: 'Covers the core day-of needs at a price that makes it easy to keep one pre-packed and ready rather than repacking from a general bag each trip',
  ...
  },
  {
    ...
    bullets: [
      'Large main compartment with internal dividers organizes supplies for multi-day trips, not just day bags',
      'Side pockets accommodate a water bottle and collapsible bowl without opening the main compartment',
      'Padded shoulder straps and chest clip distribute weight comfortably across long transit days',
    ],
  ...
  },
  {
    ...
    bestFor: 'Frequent flyers who want a proven, well-reviewed backpack with practical airport features',
    whyItWorks: 'Water-resistant construction and luggage pass-through strap address two real airport friction points — weather and carrying too much at once',
  ...
  },
  {
    ...
    bullets: [
      'Tote format fits naturally alongside luggage and under airline seats without the bulk of a backpack',
      'Stocked with a collapsible silicone bowl, water bottle, treat bag, and waste bag dispenser',
      'Sewn-in organization keeps included accessories in place without rattling loose during transit',
    ],
    bestFor: 'Travelers who prefer a tote over a backpack and want a bag that comes with useful accessories included',
    whyItWorks: 'Coming pre-organized with practical accessories removes the setup step — grab it and go without sourcing a separate bowl, water bottle, or treat pouch',
  ...
  },
  {
    ...
    whyItWorks: 'Full-week capacity with included accessories removes the need to assemble a kit piece by piece — one bag, one grab, one organized system for the whole trip',
    considerIf: 'You travel for a week or more at a time and want a bag that handles the full duration without restocking mid-trip',
  ...
  },
  {
    ...
    whyItWorks: 'Slim design that qualifies as a personal item means you keep your carry-on bin free for the carrier while still having dog supplies within reach',
  ...
  },
  {
    ...
    bullets: [
      'Thoughtfully sized main compartment carries food, treats, collapsible gear, and documents without overfilling',
      'Multiple exterior pockets keep frequently used items like leash and waste bags accessible at a moment\'s notice',
    ...
    whyItWorks: 'Emphasis on durability and practical pocket placement makes it a reliable long-term option rather than a single-trip purchase',
    considerIf: 'You fly with your dog several times a year and want a bag that stays functional and organized trip after trip',
