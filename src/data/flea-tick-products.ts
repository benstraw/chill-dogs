...
export const fleaTickProducts: FleaTickProduct[] = [
  ...
  },
  {
    ...
    name: 'The Duty Mitt Tick & Flea Repellent Mitt for Dogs (6 Count)',
    category: 'natural-spray',
    badge: 'Repellent mitt',
    bestFor: 'Dogs that bolt at the sound of a spray bottle, and owners who want targeted application instead of a mist.',
    offers: [
    ...
    ctaLabel: 'Check price on Chewy',
    coverage: 'Wipe-on repellent application',
    duration: 'Six single-use mitts per box',
    howItWorks: 'Pre-saturated cedarwood, lemongrass, and citronella mitt you wipe over the coat instead of spraying.',
    bullets: [
      'Wipe-on format avoids the spray-bottle fight and keeps product off the face and eyes',
      'Same plant-oil ingredients as the sprays here, in a single-use travel format',
      'Six mitts per box, so it works better as a hike-day tool than a daily routine',
    ],
  },
  {
