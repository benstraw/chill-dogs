...
export const fleaTickProducts: FleaTickProduct[] = [
  ...
  },
  {
    ...
    name: 'Wondercide Flea, Tick & Mosquito Spray, Lemongrass (32 oz)',
    category: 'natural-spray',
    badge: 'Natural spray',
    bestFor: 'Owners who reapply often or want one bottle that also covers home and pet areas.',
    asin: 'B00V75QXEY',
    ...
    image: {
      ...
      alt: 'Wondercide Flea, Tick & Mosquito Spray, Lemongrass, 32 oz',
    },
    coverage: 'Contact use on pets and home areas as directed',
    duration: 'Short-interval reapplication',
    howItWorks: 'Larger 32 oz lemongrass spray for households that treat the dog and living areas together.',
    caution: 'Lemongrass oil is a cat-safety consideration; read the label before use in mixed-pet homes.',
    bullets: [
      'Bigger 32 oz size for owners who reapply often or treat multiple areas',
      'Listed for dogs, cats, and household surfaces, so it doubles as a home-area spray',
      'Same realistic-expectations rule as the smaller sprays: reapply and layer it',
    ],
  },
  {
    id: 'kates-rosemary-spray',
    name: "Kate's Home & Garden Flea & Tick Spray, Rosemary (16 oz)",
    category: 'natural-spray',
    badge: 'Natural spray',
    bestFor: 'Owners who want a non-Wondercide, rosemary-based spray to compare on scent or price.',
    asin: 'B0H4SM47HW',
    amazonUrl: amazonUrl('B0H4SM47HW'),
    offers: [amazonOffer('B0H4SM47HW')],
    image: {
      src: 'https://m.media-amazon.com/images/I/61eiMERWj2L._SL500_.jpg',
      alt: "Kate's Home & Garden Rosemary Flea & Tick Spray, 16 oz",
    },
    coverage: 'Contact use on pets and home areas as directed',
    duration: 'Short-interval reapplication',
    howItWorks: 'Rosemary-based spray from a different brand for owners comparing beyond Wondercide.',
    bullets: [
      'Different brand and scent (rosemary) for owners comparing natural sprays',
      'Listed for dogs and cats, with the same reapply-often reality as other plant sprays',
      'Useful as a scent or price alternative if a Wondercide spray is out of stock',
    ],
  },
  {
    ...
    bestFor: 'Owners who want a cedarwood-oil spray and prefer to buy on Chewy.',
    offers: [
      chewyOffer('https://www.chewy.com/natures-dome-cedarwood-flea-tick/dp/3684302', 'best-natural-flea-and-tick-products-for-dogs'),
    ],
    coverage: 'Contact use on pets and home areas as directed',
    duration: 'Short-interval reapplication',
    howItWorks: 'Cedarwood-oil spray for owners who dislike minty or lemongrass scents.',
    ctaLabel: 'Check price on Chewy',
    bullets: [
      'Cedarwood-forward oil formula for a different scent than the Wondercide and Kate’s sprays',
      'Chewy-stocked, so it fits an existing Chewy order',
      'Like other plant sprays, works best with frequent reapplication and realistic expectations',
    ],
  },
  {
    id: 'isabellas-clearly-natural-spray',
    name: "Isabella's Clearly Natural Flea & Tick Spray",
    category: 'natural-spray',
    badge: 'Natural spray',
    bestFor: 'Owners comparing another plant-based spray brand available on Chewy.',
    offers: [
    ...
    coverage: 'Contact use on pets and home areas as directed',
    duration: 'Short-interval reapplication',
    howItWorks: 'Another natural spray brand for owners who want more than one option to compare.',
    ctaLabel: 'Check price on Chewy',
    bullets: [
      'A different natural spray brand for owners who want more than one option to compare',
      'Chewy-stocked alternative to the Amazon spray options above',
      'Best used as a prevention layer with coat checks and cleanup, not infestation rescue',
    ],
  },
  {
    ...
    category: 'natural-spray',
    badge: 'Natural spray',
    bestFor: 'Owners who want a straightforward natural dog spray from Chewy.',
    offers: [
    ...
    coverage: 'Contact use on the dog as directed',
    duration: 'Short-interval reapplication',
    howItWorks: 'Dog-focused natural spray for routine, light-pressure use.',
    ctaLabel: 'Check price on Chewy',
    bullets: [
      'Dog-focused natural spray for routine, light-pressure use',
      'Chewy-stocked alternative to the Amazon spray options above',
      'Reapply often and pair with cleanup; natural sprays are prevention layers, not cures',
    ],
  },
  {
