  ...
  },
  {
    ...
    pages: [
      ...
      createSitemapPage({
        ...
        relatedLabel: 'Flea & Tick Products',
        heroProduct: safetyHero('cabins-flea-collar-4pack', 'Best Value Collar', 'Adjustable Flea & Tick Collar for Dogs'),
  ...
  },
  {
    ...
    pages: [
      ...
      createSitemapPage({
        ...
        heroProduct: comfortHero('rainmr-memory-foam-bed', 'Best Overall', 'Rainmr 7-Inch Memory Foam Dog Bed'),
        pubDate: new Date('2026-03-18'),
      }),
      createSitemapPage({
        ...
        relatedLabel: 'Best Chew-Proof Dog Beds',
        heroProduct: comfortHero('k9-ballistics-armored-crate-bed', 'Toughest Padded Pick', 'K9 Ballistics Armored Crate Bed'),
      ...
      createSitemapPage({
        ...
        relatedLabel: 'Best Dog Travel Beds',
        heroProduct: comfortHero('chuckit-travel-bed', 'Best Overall', 'Chuckit! Outdoor Travel Bed'),
        pubDate: new Date('2026-09-24'),
      }),
      createSitemapPage({
